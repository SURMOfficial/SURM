...
def replace(file_path, pattern, bhole):
    ...
    with open(file_path,'r') as old_file: #this just deletes everything, unclear why it was because I had already opened it (causes some kind of conflict)
        get_all=old_file.readlines()  
